...
/*   Updated: 2021/09/07 16:20:50 by macservis        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void) {
	...
	std::cout << std::endl;
	std::cout << "uintptr_t x value 	= " << x << std::endl;
	std::cout << std::endl;
	...
	std::endl;
	std::cout << "--------------------------" << std::endl;
	std::cout << "randomData address	-> " << &randomData << std::endl;
	std::cout << "randomDataPtr		-> " << randomDataPtr << std::endl;
